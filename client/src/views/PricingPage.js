    ...
    return (
      <>
        ...
        >
          ...
          >
            <div className='h1' style={{ textAlign: 'center', color: 'white' }}>
          ...
          >
            Purchase a voucher from Darlington or David official voucher
            resellers
            <div
              className='map'
              style={{
        ...
        <div className='wrapper' style={{ paddingTop: '16vh' }}>
          <div className='section'>
            <Container className='align-items-center'>
              ...
              >
                Purchase a voucher from Darlington or David - 0609835400
              </h1>
              <hr
                className='line-info'
                style={{
